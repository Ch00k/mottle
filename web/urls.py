...
urlpatterns = [
    ...
    path("tracks/<str:track_id>/add-to-playlist/", views.add_track_to_playlist, name="add_track_to_playlist"),
    path("saved-tracks/", views.saved_tracks, name="saved_tracks"),
    path("saved-tracks/<str:track_id>/delete/", views.delete_saved_track, name="delete_saved_track"),
